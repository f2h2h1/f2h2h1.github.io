...
爬虫与反爬虫的经验
    ...
    反爬虫
        ...
        请求前置的静态资源时带上特定的 cookie，请求内容时要先有这些cookie才返回具体内容？其实用无头浏览器可以很容易就绕过这个吧
        最终目标
    ...
    六艺
        君子六艺
            礼 五礼
                ...
                嘉礼
            乐 六乐
                云门大卷(黄帝)、大咸(尧)、大韶(舜)、大夏(禹)、大濩(汤)、大武(周)
                前四为文，后二为武
            射 五种射技
                白矢、参连、剡注、襄尺、井仪
            御 骑马或驾驶马车
            ...
            数 九数 
                ...
                少广(已知面积或体积，求边长)
                商功(测量体积，计算工程用工)
                均输(以田地人户数量求赋税金额;以道路远近及负载轻重求脚费多寡;以不同的物价高低求平均数等，为一种赋税计算。)
                方程(正数负数加减法)
                赢不足(盈亏计算)
                旁要(勾股)
        四书五经六艺
...
物理
    ...
    相对论 -> 宇宙学标准模型
    量子物理 -> 粒子物理学标准模型
        高能物理 通常是指 量子力学 应为做量子力学的实验需要很高的能量，例如 大型对撞机
    ...
    基本普朗克单位
        ...
        普朗克电荷
        普朗克温度
        普朗克尺度 通常是指 普朗克长度，一些语境下也可能是指 普朗克单位制
        普朗克长度规定了物质的最小尺度 ，如果再小就毫无意义了
        一瞬间 == 一个普朗克时间
        第一个瞬间 == 第一个普朗克时间
无线电
...
时间
    ...
    一年有多少天？
        ...
        平回归年（Mean Tropical Year） -> 平均回归年
        恒星年（Sidereal Year）是指地球绕太阳公转一周的时间，每个恒星年为365.256363004天；
        回归年（tropical Year）是太阳直射点在南北回归线之间移动的周期，每个回归年则为365.242189天。
        太阳年（solar year）就是回归年
        日历年（Calendar Year） 格利高历的平均 365.2425 儒略历平均 365.25
        什么是恒星年
            恒星年是指地球绕太阳公转一周，太阳在黄道上相对于遥远恒星背景回到同一位置所需的时间。
            由于恒星极其遥远（最近的恒星也在4光年外），它们的视差极小，可以视为绝对固定的参考点。
            从地球上看，太阳在某颗恒星旁边出发，绕黄道一圈后，再次回到那颗恒星旁边——这个周期就是一个恒星年。
            地球公转 360° 的真正周期，太阳回到"同一颗恒星"的位置
            365.25636 日
        为什么 恒星年 和 回归年 不一样？
            因为有岁差的存在，所以恒星年和回归年不一样
            恒星年 地球公转 360°
            春分点回归年 地球公转约359.986°（少了约50角秒）
        岁差（Precession） 是什么？
            因为有岁差的存在所以恒星年大于回归年
            差值：约 20分24秒
    历法
