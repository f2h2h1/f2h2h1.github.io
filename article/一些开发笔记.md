...
curl -L -v -O https://static.rust-lang.org/dist/rust-1.91.1-aarch64-unknown-linux-gnu.tar.xz
curl -L -O https://static.rust-lang.org/dist/rust-1.91.1-aarch64-unknown-linux-gnu.tar.xz
tar -Jxf rust-1.91.1-aarch64-unknown-linux-gnu.tar.xz
cd rust-1.91.1-aarch64-unknown-linux-gnu.tar
bash install.sh
