...
define( 'WP_HOME', 'https://8081-cs-285386365050-default.cs-asia-east1-cats.cloudshell.dev' ); 
define( 'WP_SITEURL', 'https://8081-cs-285386365050-default.cs-asia-east1-cats.cloudshell.dev' );
...
docker run -it --rm --name my-maven-project -v "$(pwd)":/usr/src/mymaven -w /usr/src/mymaven maven:3.9-eclipse-temurin-17-alpine mvn clean install


alias mvn='docker run -it --rm --name my-maven-project -v "$(pwd)":/usr/src/mymaven -w /usr/src/mymaven maven:3.9-eclipse-temurin-17-alpine mvn'
