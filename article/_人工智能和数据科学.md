...
docker exec -it 容器id /usr/bin/create-account --config /etc/dendrite/dendrite.yaml --username user1
docker exec -it 容器id /usr/bin/create-account --config /etc/dendrite/dendrite.yaml --username chatbot
命令运行完后要记得记下 token
