...
openssl req -newkey rsa:4096 -nodes -keyout rsa_private_key.pem -x509 -days 365 -out domain.crt -subj "/C=Country/ST=State/L=City/O=Ltd/OU=Section/CN=localhost"
```
